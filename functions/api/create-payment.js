...
function md5(inputString) {
  ...
  function rh(n){var j='',i=-1;while(++i<4)j+=hc[(n>>(i*8+4))&0xF]+hc[(n>>(i*8))&0xF];return j;}
  ...
  function sb(x){
    var i,nblk=((x.length+8)>>6)+1,blks=new Array(nblk*16).fill(0);
  ...
  var i,x=sb(inputString),
    a=1732584193,b=-271733879,c=-1732584194,d=271733878,olda,oldb,oldc,oldd;
